-- Pubs Database Sample Data Insert Statements
...
('New Position - title not formalized yet', 10, 10),
...
('MC2222', 'Silicon Valley Gastronomic Treats', 'mod_cook', '0877', 19.99, 0.00, 12, 2032, 'Favorite recipes for quick, easy, and elegant meals, tried and tested by people who never have time to eat, let alone cook.', '1991-06-09'),
...
('MC3026', 'The Psychology of Computer Cooking', 'UNDECIDED', '0877', NULL, NULL, NULL, NULL, NULL, '2024-11-10'),
...
('PC9999', 'Net Etiquette', 'popular_comp', '1389', NULL, NULL, NULL, NULL, 'A must-read for computer conferencing debutantes!.', '2024-11-10'),
...
('TC4203', 'Fifty Years in Buckingham Palace Kitchens', 'trad_cook', '0877', 11.95, 4000.00, 14, 15096, 'More anecdotes, more menus, more recipes than the first book. The Royal Recipes has the method, this the mood. Superb writing.', '1991-06-12'),
('TC7777', 'Sushi, Anyone?', 'trad_cook', '0877', 14.99, 8000.00, 10, 4095, 'Detailed instructions on how to make authentic Japanese sushi in your spare time. All you need are the fish and the desire.', '1991-06-12');
GO
...
('807-91-6654', 'TC4203', 2, 40),
('846-92-7186', 'PC8888', 2, 50),
('899-46-2035', 'MC3021', 2, 25),
('899-46-2035', 'PS2091', 1, 100),
('998-72-3567', 'PS2106', 1, 100),
('998-72-3567', 'PS7777', 2, 100);
GO
...
('7896', '123456', '1993-12-12', 10, 'Net 60', 'MC2222'),
('7896', 'TQ456', '1993-12-12', 10, 'Net 60', 'BU7832'),
...
('MC3021', 4001, 6000, 14),
('MC3021', 6001, 8000, 16),
('MC3021', 8001, 10000, 18),
('MC3021', 10001, 12000, 20),
('MC3021', 12001, 50000, 22),
('TC3218', 0, 2000, 10),
('TC3218', 2001, 4000, 12),
('TC3218', 4001, 6000, 14),
('TC3218', 6001, 8000, 16),
...
('BU1111', 10001, 12000, 16),
('BU1111', 12001, 16000, 18),
('BU1111', 16001, 20000, 20),
('BU1111', 20001, 24000, 22),
('BU1111', 24001, 28000, 24),
('BU1111', 28001, 50000, 26),
('MC2222', 0, 2000, 10),
('MC2222', 2001, 4000, 12),
('MC2222', 4001, 8000, 14),
...
-- Insert Pub_Info
INSERT INTO pub_info (pub_id, pr_info) VALUES
('0736', 'This is sample text data for New Moon Books, publisher 0736 in the pubs database. New Moon Books is located in Boston, Massachusetts.'),
...
('9901', 'This is sample text data for GGG&G, publisher 9901 in the pubs database. GGG&G is located in München, Germany.'),
...
('F-C16315M', 'Francisco', NULL, 'Chang', 4, 227, '9952', '1990-11-03'),
...
('RBM23061F', 'Rita', 'B', 'Müller', 5, 198, '1622', '1993-10-09'),
('MJP25939M', 'Maria', 'J', 'Pontes', 5, 246, '1756', '1989-03-01'),
('PCM30286M', 'Philip', 'C', 'Morris', 6, 215, '0877', '1992-01-29'),
('TPO32660F', 'Tina', 'P', 'O''Rourke', 6, 167, '9952', '1988-11-27'),
('MFS52347M', 'Martin', 'F', 'Sommer', 10, 165, '0736', '1990-04-13'),
('PKB97533F', 'Patricia', 'K', 'Brown', 12, 35, '0736', '1987-02-27'),
('MGK44605M', 'Matti', 'G', 'Karttunen', 6, 220, '0736', '1994-05-01'),
('POK93028M', 'Palle', 'O', 'Ibsen', 7, 195, '0736', '1993-09-17'),
('JYL26161F', 'Janine', 'Y', 'Labrune', 9, 172, '9901', '1991-05-26'),
('CFH28514M', 'Carlos', 'F', 'Hernadez', 5, 211, '9999', '1989-04-21'),
('VPA30890F', 'Victoria', 'P', 'Ashworth', 6, 140, '0877', '1990-09-13'),
('L-B31947F', 'Lesley', NULL, 'Brown', 7, 120, '0877', '1991-02-13'),
('ARD36773F', 'Anabela', 'R', 'Domingues', 8, 100, '0877', '1993-01-27'),
('M-R38834F', 'Martine', NULL, 'Rancé', 14, 75, '0877', '1992-02-05'),
('PHF38899M', 'Peter', 'H', 'Franken', 10, 75, '0877', '1992-05-17'),
('DBT39435M', 'Daniel', 'B', 'Tonini', 11, 75, '0877', '1990-01-01'),
('H-B39728F', 'Helen', NULL, 'Bennett', 12, 35, '0877', '1989-09-21'),
('PMA42628M', 'Paolo', 'M', 'Accorti', 13, 35, '0877', '1992-08-27'),
('ENL44273F', 'Elizabeth', 'N', 'Lincoln', 14, 35, '0877', '1990-07-24'),
('MGK44605M', 'Matti', 'G', 'Karttunen', 12, 50, '0736', '1994-05-01'),
('PDI47470M', 'Pirkko', 'D', 'Isolauri', 11, 75, '0736', '1993-11-29'),
('MMS49649F', 'Mary', 'M', 'Saveley', 8, 175, '0736', '1993-06-29'),
('GHT50241M', 'Gary', 'H', 'Thomas', 9, 170, '0736', '1988-08-09'),
('DBM68609F', 'Dorothy', 'B', 'Matthews', 11, 100, '0736', '1988-02-13'),
...
('Y-L77953M', 'Yoshi', NULL, 'Latimer', 12, 32, '1389', '1989-06-11'),
('CGS88322F', 'Carine', 'G', 'Schmitt', 13, 64, '1389', '1992-07-07'),
('PSP68661F', 'Paula', 'S', 'Parente', 8, 125, '1389', '1994-01-19'),
('A-C71970F', 'Aria', NULL, 'Cruz', 10, 87, '1389', '1991-10-26'),
('MAP77183M', 'Matti', 'A', 'Karttunen', 14, 25, '1389', '1992-05-01'),
('KFJ64308F', 'Karin', 'F', 'Josephs', 14, 100, '0736', '1994-10-17'),
('DLS66431F', 'Diego', 'L', 'Saavedra', 8, 236, '0877', '1991-07-07'),
