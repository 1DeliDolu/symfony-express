...
use App\Form\Pubs\EmployeeType;
use App\Repository\Pubs\EmployeeRepository;
...
final class EmployeeController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('pubs/employee/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('pubs/employee/new.html.twig', [
            'employee' => $employee,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('pubs/employee/show.html.twig', [
            'employee' => $employee,
        ]);
    }
    ...
    public function edit(Request $request, #[MapEntity(mapping: ['empId' => 'empId'])] Employee $employee): Response
    {
        ...
        return $this->render('pubs/employee/edit.html.twig', [
            'employee' => $employee,
            'form' => $form,
        ]);
    }
