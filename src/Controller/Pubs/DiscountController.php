...
use App\Form\Pubs\DiscountType;
use App\Repository\Pubs\DiscountRepository;
...
final class DiscountController extends AbstractController
{
    ...
    public function index(DiscountRepository $discountRepository): Response
    {
        ...
        return $this->render('pubs/discount/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pubs/discount/new.html.twig', [
            'discount' => $discount,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('pubs/discount/show.html.twig', [
            'discount' => $discount,
        ]);
    }
    ...
    public function edit(Request $request, #[MapEntity(mapping: ['discountType' => 'discountType'])] Discount $discount, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pubs/discount/edit.html.twig', [
            'discount' => $discount,
            'form' => $form,
        ]);
    }
